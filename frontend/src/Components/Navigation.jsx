...
const Navigation = () => {
  return (
    <div className="flex justify-between bg-orange-500 text-white ">
      ...
      <div className="links mr-12 mt-7">
        <ul className="flex">
          <li className=" hover:text-black  hover:bg-orange-100  rounded mr-3 p-2">
            <a href="#" className="flex items-center">
              <GoHomeFill className="mr-2 w-5 h-6 "/>
          ...
          <li className=" hover:text-black  hover:bg-orange-100 rounded mr-3 p-2">
            <a href="#" className="flex items-center">
              <ImProfile className="mr-2 w-5 h-6 "/>
